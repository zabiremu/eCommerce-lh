            ...
            <div class="card">
                <div class="card-body">
                    <form
                        ...
                        @endif
                        <div class="mb-3">
                            <label for="sub_category_id" class="form-label">Select Category/Sub Category</label>
                            <select name="sub_category_id" id="sub_category_id"
                                class="form-control @error('sub_category_id')
                                is-invalid
                                @enderror">
                                <option selected disabled>Select Category/Sub Category</option>
                                @foreach ($subCategories as $subCategory)
                                    <option disabled>{{ $subCategory->category_name }}</option>
                                    <option value="{{ $subCategory->id }}"
                                        @if (isset($row->sub_category_id)) {{ $subCategory->id === $row->sub_category_id ? 'selected' : '' }} @endif>
                        ...
                        <div class="mb-3">
                            <label for="title" class="form-label">Child Category title</label>
                        ...
                        <div class="mb-3">
                            <label for="slug" class="form-label">Child Category Slug</label>
                            <input type="text"
